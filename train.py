...
# copy the weights and bias from the policy_net to the target_net
...
for i_episode in range(config.num_episodes):
    ...
    state, info = env.reset()
    # converts the state into a Pytorch tensor and adds a batch dimension, making it compatible with the NN
